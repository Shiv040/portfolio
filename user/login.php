                                ...
                                <figure class="sl-registercontent__img">
                                    ...
                                    <figcaption>
                                        <strong class="sl-registerlogo">
                                            <a href="index-2.html"><img src="" alt="Images Description"></a>
                                        </strong>
                                       
                                        <div class="sl-descritpion">
                                            <p>Welcome to Utshav Hub, your one-stop platform for seamless event planning and management. Our system allows organizers to create, manage, and promote events while giving attendees an easy way to explore and register for upcoming events.

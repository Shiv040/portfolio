...
<!-- Mirrored from amentotech.com/htmls/servosell/dashboard-profile-settings.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 14 Feb 2025 10:14:52 GMT -->
<head>
    <meta charset="utf-8">
...
<body>
                ...
                <div class="sl-main-header__upper">
                    ...
                    <div class="sl-user">
                        <a href="javascript:void(0);" data-toggle="modal" data-target="#loginpopup">
                            <img src="images/index/user-logo.gif" alt="Image Description">
                                <span class="sl-user__description"><em class="d-block">Evening!</em>Guest25568</span>
                                ...
                                <form class="sl-formtheme sl-formlogin">
                                    <fieldset>
                                        <div class="form-group">
                                            <input type="text" name="email" value="" class="form-control sl-form-control" placeholder="Your Email*" required="">
                                        </div>
                                        <div class="form-group">
                                            <input type="password" value="" class="form-control sl-form-control" placeholder="Password*">
                                        </div>
                                        <div class="form-group sl-btnarea">
                                            <button type="submit" class="btn sl-btn">login</button>
                                        ...
                                        <div class="sl-usersinfo">
                                            <div class="single-chart">
                                                ...
                                                <figure class="sl-userprofileimg">
                                                    <img src="images/insight/profile.jpg" alt="img description">
                                                </figure>
                                            </div>
                                            <div class="sl-title">
                                            ...
                                            <fieldset>
                                                <div class="sl-form__wrap">
                                                    <div class="form-group form-group-half">
                                                        <input class="form-control sl-form-control" type="text" placeholder="First Name*">
                                                    </div>
                                                    <div class="form-group form-group-half">
                                                        <input class="form-control sl-form-control" type="text" placeholder="Last Name*">
                                                    </div>
                                                    <div class="form-group form-group-half">
                                                        <label class="sl-profileSetting__toltip">
                                                            <input class="form-control sl-form-control" type="text" placeholder="Company/User Title">
                                                            <i class="ti-help-alt toltip-content" data-tipso="name"></i>
                                                        </label>
                                                    </div>
                                                    <div class="form-group form-group-half">
                                                        <label class="sl-profileSetting__toltip">
                                                            <input class="form-control sl-form-control" type="text" placeholder="Add Slogan Here">
                                                            <i class="ti-help-alt toltip-content" data-tipso="name"></i>
                                                        </label>
                                                    </div>
                                                    <div class="form-group form-group-half">
                                                        <input class="form-control sl-form-control" type="number" placeholder="Phone">
                                                    </div>
                                                    <div class="form-group form-group-half">
                                                        <input class="form-control sl-form-control" type="email" placeholder="Email*">
                                                    </div>
                                                    <div class="form-group form-group-half">
                                                        <input class="form-control sl-form-control" type="number" placeholder="Mobile">
                                                    </div>
                                                    <div class="form-group form-group-half">
                                                        <input class="form-control sl-form-control" type="text" placeholder="Website Url">
                                                    </div>
    ...
    <script src="js/vendor/tinymce/tinymce.min4bb5.js?apiKey=4cuu2crphif3fuls3yb1pe4qrun9pkq99vltezv2lv6sogci"></script>
...
<!-- Mirrored from amentotech.com/htmls/servosell/dashboard-profile-settings.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 14 Feb 2025 10:14:55 GMT -->
</html>

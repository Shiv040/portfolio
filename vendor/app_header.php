...
if(isset($_SESSION['vendor_id'])){
  ...
  $v_query = "SELECT *
   ...
   on v.vender_id=b.vender_id
    WHERE v.vender_id = '$v_id'";
  ...
  <div class="header-actions">
    ...
    <div class="dropdown">
      <a id="userSettings" class="dropdown-toggle d-flex p-2 pe-0 ms-3 align-items-center" href="#!"
        ...
        <span class="me-2 text-white d-md-block d-none"><?php echo strtoupper($v_data['name']);?></span>
        <img src="logo_image/<?php echo $v_data['logo'];?>" class="rounded-2 img-3x" alt="User Image" />
      </a>
      <div class="dropdown-menu dropdown-menu-end">
        <div class="px-3">Vendor</div>
        <div class="mx-3 my-2 d-grid gap-1">
            <a href="vendor-profile.php?vendor_id= <?php echo $v_id;  ?>" class="btn btn-light">Profile</a>

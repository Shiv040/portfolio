<style>
    .sl-main-banner .item img {
        width: 100%;
        height: 460px; /* Set your desired fixed height here */
...
<div class="sl-main-banner">
    ...
    <div class="sl-main-banner__content">
        <h1><span>Discover the Best</span>Services</h1>
        <p>Find top-notch event planners, caterers, decorators, and more to make your event unforgettable. Let us help you create memories that last a lifetime.</p><div class="sl-main-banner__btn">
        </div>
